...
ActiveRecord::Schema.define(:version => 20140616112633126) do
  ...
  create_table "resorts", :force => true do |t|
    ...
    t.string   "icon_night_zero"
    t.string   "icon_night_one"
    t.string   "icon_night_two"
    t.string   "icon_night_three"
